...
extension UIResponder {
    ...
    @discardableResult
    func noticeTop(_ text: String, textcolor: UIColor = UIColor.white, autoClear: Bool = true, autoClearTime: Int = 1) -> UIWindow{
        color = textcolor
    ...
    // new apis from v3.3
    @discardableResult
    func noticeSuccess(_ text: String, textcolor: UIColor = UIColor.white, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        color = textcolor
        return SwiftNotice.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeError(_ text: String, textcolor: UIColor = UIColor.white, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        color = textcolor
        return SwiftNotice.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    func noticeInfo(_ text: String, textcolor: UIColor = UIColor.white, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        color = textcolor
    ...
    // old apis
    @discardableResult
    func successNotice(_ text: String, textcolor: UIColor = UIColor.white, autoClear: Bool = true) -> UIWindow{
        color = textcolor
        return SwiftNotice.showNoticeWithText(NoticeType.success, text: text, autoClear: autoClear, autoClearTime: 2)
    }
    @discardableResult
    func errorNotice(_ text: String, textcolor: UIColor = UIColor.white, autoClear: Bool = true) -> UIWindow{
        color = textcolor
        return SwiftNotice.showNoticeWithText(NoticeType.error, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func infoNotice(_ text: String, textcolor: UIColor = UIColor.white, autoClear: Bool = true) -> UIWindow{
        color = textcolor
        return SwiftNotice.showNoticeWithText(NoticeType.info, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    func notice(_ text: String, textcolor: UIColor = UIColor.white, type: NoticeType, autoClear: Bool, autoClearTime: Int = 3) -> UIWindow{
        color = textcolor
